...
Uncensored GG, LOGNO, and WEI additionally support whole-model LAML selection
and LAML bootstrap with their standard links. Their censored wrappers continue
to use the existing censored-likelihood fitting routes rather than LAML.
